...
MODEL=${MODEL:-/mnt/data/cjyoutput/output/multiview_amass_rumpl/multiview_rumpl_999/distill_hardv_legw07_full_20260711_2026-07-11_01-22-52/model_best.pth.tar}
COMMENT_PREFIX=${COMMENT_PREFIX:-hardv_legw07_full_v2}
OUT_ROOT=${1:-/mnt/data/cjyoutput/cmu_v2_eval_hardv_legw07_full_20260711_$(date +%Y%m%d_%H%M%S)}
