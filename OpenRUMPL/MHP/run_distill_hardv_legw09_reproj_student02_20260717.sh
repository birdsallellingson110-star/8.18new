...
# Same loss, applied only to the selected hard-view V2 student observations.
export REPROJ_LAMBDA=0
export STUDENT_REPROJ_W=0.2
...
exec /home/lixiaob/cjy/rumpl_venv310/bin/python run/train_rumpl.py \
  ...
  --gpus 0 \
  --workers 8 \
  --exp-name distill_hardv_legw09_reproj_student02_20260717
