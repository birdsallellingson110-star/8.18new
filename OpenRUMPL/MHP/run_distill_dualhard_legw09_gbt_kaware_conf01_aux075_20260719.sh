...
export AUX_MULTIK_W=0.75 AUX_MULTIK_MIN=3 AUX_MULTIK_MAX=4
export GBT_CONF_BIAS=0.1 GBT_GEOM_BIAS=0.12 GBT_VIEW_AWARE=1
export GBT_V2_SCALE=0 GBT_V3_SCALE=1 GBT_V4_SCALE=2 GBT_TOKEN_DROPOUT=0
...
exec /home/lixiaob/cjy/rumpl_venv310/bin/python run/train_rumpl.py \
  ...
  --gpus 0 \
  --workers 8 \
  --exp-name distill_dualhard_legw09_gbt_kaware_conf01_aux075_20260719
