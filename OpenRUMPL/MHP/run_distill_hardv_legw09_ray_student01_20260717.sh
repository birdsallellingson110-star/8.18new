...
# Stable geometry consistency in world space, applied only to the hard student.
export REPROJ_LAMBDA=0.0
export STUDENT_REPROJ_W=0.0
export RAY_LAMBDA=0.0
export STUDENT_RAY_W=0.1
export RAY_BETA=0.01
...
exec /home/lixiaob/cjy/rumpl_venv310/bin/python run/train_rumpl.py \
  ...
  --gpus 0 \
  --workers 8 \
  --exp-name distill_hardv_legw09_ray_student01_20260717
