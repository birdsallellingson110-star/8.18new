...
TRAIN=/home/lixiaob/cjy/OpenRUMPL/MHP/run_rumpl_gbt_curriculum5_both_seed_20260721.sh
...
find_run() {
  ...
  find "$ROOT" -maxdepth 1 -type d \
    -name "rumpl_gbt_curriculum5_both_seed${seed}_20260721_*" -print | sort | tail -n1
}
