...
export MPLCONFIGDIR=/mnt/data/cjydata/.cache/matplotlib
...
# Confidence-weighted robust reprojection on the main random-K forward only.
export REPROJ_LAMBDA=0.2
export STUDENT_REPROJ_W=0
...
exec /home/lixiaob/cjy/rumpl_venv310/bin/python run/train_rumpl.py \
  ...
  --gpus 0 \
  --workers 8 \
  --exp-name distill_hardv_legw09_reproj_main02_20260717
