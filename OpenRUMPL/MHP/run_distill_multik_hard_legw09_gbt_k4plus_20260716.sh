...
# Unified hard sparse-view distillation. Geometry attention is enabled only for
# K>=4, where redundant views make geometry reliability useful.
export DISTILL_W=1
...
exec /home/lixiaob/cjy/rumpl_venv310/bin/python run/train_rumpl.py \
  ...
  --gpus 0 \
  --workers 8 \
  --exp-name distill_multik_hard_legw09_gbt_k4plus_20260716
