...
# Unified sparse-view distillation with geometry-biased VFT.
export DISTILL_W=1
...
# Keep confidence bias off; previous V2 GBT-v2 showed confidence+geom can hurt
# weak pairs. Geometry bias is view-aware and disabled for V=2.
...
exec /home/lixiaob/cjy/rumpl_venv310/bin/python run/train_rumpl.py \
  ...
  --gpus 0 \
  --workers 8 \
  --exp-name distill_multik_hard_legw09_gbt_20260714
