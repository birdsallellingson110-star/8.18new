...
from core.function_mpl import inference
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='/mnt/data/cjyoutput/output/inference_mpl_result.npz'
    )
...
def main():
    ...
    inference_dataset = dataset.multiview_inference_openmplposer_mpl(config)
