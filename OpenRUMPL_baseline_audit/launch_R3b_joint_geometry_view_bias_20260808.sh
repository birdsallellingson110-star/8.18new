#!/usr/bin/env bash
# R3b: H76 frozen + per-joint ray inconsistency bias at VFT fusion rows.
set -euo pipefail
...
export CODE_OVERRIDE="R3b_${variant}"
export BASE_OVERRIDE="${ROOT}/R3b_joint_geometry_view_bias_20260808"
export TAG_OVERRIDE="R3b_H76_jointGeometryViewBias_w322_${variant}_seed0_20260808"
export CONTROL_NOTE_OVERRIDE="H76 frozen; per-joint normalized ray inconsistency fusion-row bias; 5 epochs; lr=${lr}"
...
export RUMPL_JOINT_GEOMETRY_VIEW_BIAS=1
export RUMPL_TRAIN_SCOPE=joint_geometry_view_bias
