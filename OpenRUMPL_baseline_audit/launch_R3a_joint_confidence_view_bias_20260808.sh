#!/usr/bin/env bash
# R3a: H76 frozen + per-joint 2D confidence bias at VFT fusion rows.
set -euo pipefail
...
export CODE_OVERRIDE="R3a_${variant}"
export BASE_OVERRIDE="${ROOT}/R3a_joint_confidence_view_bias_20260808"
export TAG_OVERRIDE="R3a_H76_jointConfidenceViewBias_w322_${variant}_seed0_20260808"
export CONTROL_NOTE_OVERRIDE="H76 frozen; per-joint 2D confidence fusion-row bias; 5 epochs; lr=${lr}"
...
export RUMPL_JOINT_CONFIDENCE_VIEW_BIAS=1
export RUMPL_TRAIN_SCOPE=joint_confidence_view_bias
