#!/usr/bin/env bash
# R2b: H76 frozen + normalized cross-view ray inconsistency at VFT fusion rows.
set -euo pipefail
...
export CODE_OVERRIDE="R2b_${variant}"
export BASE_OVERRIDE="${ROOT}/R2b_geometry_view_bias_20260808"
export TAG_OVERRIDE="R2b_H76_geometryViewBias_w322_${variant}_seed0_20260808"
export CONTROL_NOTE_OVERRIDE="H76 frozen; normalized cross-view ray inconsistency fusion-row bias; 5 epochs; lr=${lr}"
