#!/usr/bin/env bash
# KPA-faithful = A2 + KTPFormer SemGCN KPA (no softmax).
# usage: $0 GPU [VARIANT]
set -euo pipefail

gpu=${1:?usage: $0 GPU [VARIANT]}
variant=${2:-KPA_a2_seed0_20260725}
...
export RUMPL_MULTI_HYP=1 RUMPL_CONF_FILM=0
...
echo "KPA-faithful + A2 variant=$variant"
