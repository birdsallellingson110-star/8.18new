...
ROOT=/mnt/data/cjyoutput/open_source_fusion_audit_20260812/RIGR_Correspondence_V234_StageHeads_20260812
...
run_one() {
  ...
  CUDA_VISIBLE_DEVICES=${gpu} "${PY}" -u "${AUDIT}/train_e2_v234_universal_20260812.py" \
    ...
    --output-dir "${out}" --attention-depth 2 --stage-heads \
...
wait "${pid0}"
wait "${pid1}"
date '+%F %T correspondence V234 stage-head E2 completed'
