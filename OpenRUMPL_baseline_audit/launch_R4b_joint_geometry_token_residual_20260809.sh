#!/usr/bin/env bash
# R4b: H76 frozen + zero-initialized per-joint token residual driven by ray consistency.
set -euo pipefail
...
export CODE_OVERRIDE="R4b_${variant}"
export BASE_OVERRIDE="${ROOT}/R4b_joint_geometry_token_residual_20260809"
export TAG_OVERRIDE="R4b_H76_jointGeometryTokenResidual_w322_${variant}_seed${seed}_20260809"
export CONTROL_NOTE_OVERRIDE="H76 frozen; zero-init per-joint feature residual driven by normalized ray consistency; 5 epochs; lr=${lr}"
