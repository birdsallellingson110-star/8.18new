#!/usr/bin/env python3
"""Evaluate the unbiased-subset E2 scorer with E2-C2 temperatures."""
...
def main():
    ...
    payload = {
        "method": "unbiased E2 scorer (no subset penalty) + snap/bone, calibrated T",
        "protocol": "strict flip=false, H36M S9/S11, action-equal All-17",
        "temperatures": temperature,
        "per_seed_mm": per_seed,
        "mean_mm": means,
        "baseline_e2_c2_soft_cal": {"V2": 38.700, "V3": 29.486, "V4": 27.274},
        "oracle_expanded": {"V2": 31.547, "V3": 20.153, "V4": 16.126},
    }
